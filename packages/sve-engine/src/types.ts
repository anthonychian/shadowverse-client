...
export type Effect =
  ...
  | { op: "buffFieldTrait"; trait: string; atk?: number; def?: number; keyword?: Keyword }
  ...
  | { op: "tutorFromDeck"; filter: DeckFilter; to: "hand" | "exArea" | "field" }
  | {
  ...
  | { op: "selectFromHand"; filter: DeckFilter; to: "exArea" | "hand"; optional?: boolean }
