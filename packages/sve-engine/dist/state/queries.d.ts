...
export declare function isFollowerCard(cardNo: string): boolean;
export declare function isFieldFollower(state: GameState, card: CardInstance): boolean;
export declare function canDeclareAttack(state: GameState, card: CardInstance): boolean;
...
export declare function getPassivePlayCostIncrease(state: GameState, player: PlayerId, cardNo: string): number;
...
export declare function followerIgnoresWard(state: GameState, card: CardInstance, player: PlayerId): boolean;
export declare function controllerHasDefAsAttackAura(state: GameState, player: PlayerId): boolean;
export declare function getAttackerStrikeDamage(state: GameState, attacker: CardInstance, player: PlayerId): number;
...
export declare function isSanguineActive(state: GameState, player: PlayerId): boolean;
