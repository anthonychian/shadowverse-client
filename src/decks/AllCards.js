export const allCards = [
  ...
  "Kyou, Wooden Bell of the Tree's Justice",
  "Tia, Crystalian Noble",
  "Pruner of the Tree's Authority",
  "May, Eager Elf",
  "As You Sow, So Shall You Reap",
  "Fist Fighter of the Tree's Capital",
  "Blossoming Lunerian",
  "Planting the Seeds in Amitabha's Pure Land",
  "Prayer Child of the Tree's Law",
  ...
  "Overhead Investigator",
  "Darksaber Melissa",
  "Giga Blade",
  "Bottleneck Inspector",
  "Sellsword Lucius",
  "Assistance with Investigating Heresy",
  "Blind Spot Observer",
  "Monika, Cloudhall Admiral",
  "Princess Teena",
  "Holy Bear Knight",
  "Luminous Standard",
  "Plana, Sterling Luster",
  "Fleurage, Jewelry Manager",
  ...
  "Tenka, Enzui Vice President",
  "Fafnir, Cunning Wyrm",
  "Dragon-Eyed Scribe",
  "Prophetic Dragon",
  "A Moment After School",
  "Saibi’s Disciplinary Committee",
  "Ian, Dragon Buster",
  "Shuyoku’s Admission Celebration",
  "Electric Claw's Going-Home Club Member",
  "Serpent Drake",
  "Draconic Mercenary",
  "Estrella Beast",
  "Orca Run",
  "Ilze & Ulze, Centennial Reapers",
  "Ved, Wolf of Burials",
  "Vania, Crimson Majesty",
  "Serpent of Greed",
  "Veight, Twilit Highborn",
  "Crescent Moon of a Hundred Deaths",
  "Piercing Crow",
  "Full Moon of a Hundred Passings",
  ...
  "Tenmei, Arbiter of Desire",
  "Elana, Purest Prayer",
  "Oath Breaker's Giver",
  "Imina, Mad Eidolon",
  "Unwavering Prayer",
  "Bearer of Additional Penalties",
  "Lorena, Iron-Willed Priest",
  "Pioneer's Conversation",
  "Closed Eyes Supporter",
  "Mugnier, Purifying Light",
  "Armed Al-mi'raj",
  "Heavenly Hound",
  "Golden Bell",
  "Bansai Suzuki, Shinobi Deacon",
  "Saito, Mao Ward Officer",
  "Warped Progress",
  "Togh Keyoh, Neometropolis",
  "Stunfist Assassin",
  "Flame Spell Proficiency Test Rank A",
  "Cyber Glasspunk",
  "District Office Worker Class C",
